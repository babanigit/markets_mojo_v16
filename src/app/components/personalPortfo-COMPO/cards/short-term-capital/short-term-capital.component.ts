...
@Component({
  selector: 'app-short-term-capital',
  templateUrl: './short-term-capital.component.html',
  styleUrls: ['./short-term-capital.component.css'],
  standalone: true,
  imports: [CommonModule, TwoCommasPipe, RoundOffPipe],
  changeDetection: ChangeDetectionStrategy.OnPush,

})
export class ShortTermCapitalComponent implements OnInit {
